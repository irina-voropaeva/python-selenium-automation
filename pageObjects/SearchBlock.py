...
class SearchBlock(BasePage):
    ...
    def enter_job(self, word):
        self.log.info("Entering job " + word)
    ...
    def enter_city(self, word):
        self.log.info("Entering city" + word)
    ...
    def click_city_field(self):
        self.log.info("Clicking city field")
    ...
    def choose_city_kherson(self):
        self.log.info("Choosing Kherson city")
    ...
    def click_job_field(self):
        self.log.info("Clicking job field")
    ...
    def click_job_field_clear_button(self):
        self.log.info("Clicking job field clear button")
    ...
    def click_city_field_clear_button(self):
        self.log.info("Clicking city field clear button")
    ...
    def get_search_field_value(self):
        value = self.find_element(SearchLocators.LOCATOR_JOB_FIELD, time=2) \
            .text
        self.log.info("Getting search field value. Value is " + value)
        return value

    def get_city_field_value(self):
        value = self.find_element(SearchLocators.LOCATOR_CITY_FIELD, time=2) \
            .text
        self.log.info("Getting city field value. Value is " + value)
        return value

    def click_advanced_search(self):
        self.log.info("Clicking advanced search button")
